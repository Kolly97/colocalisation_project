// ==========================================================
// Background Subtraction + Coloc Prep Pipeline  --  V0.13
// Author 	: Kolja Hildenbrand
// Date   	: 2026-06-04
// Status	: OLD (superseded by v0.14.3)
//
// Base: this file is V0.10 (MorphoLibJ marker-controlled watershed, the
//       preferred multi-cell segmentation) with ONE behavioural change to the
//       infection gate. V0.11/V0.12 (pure-IJM Voronoi) are kept only as history.
//
