// ==========================================================
// Background Subtraction + Coloc Prep Pipeline  --  V0.9
// Author 	: Kolja Hildenbrand
// Date   	: 2026-06-02
// Status	: OLD (superseded by v0.14.3)
//
// NOTE: this file was mislabeled "V0.10" in its header (and MACRO_VERSION
//       "0.10.0"); corrected to V0.9 to match the filename. V0.9 is the version
//       that FIRST introduces the MorphoLibJ marker-controlled watershed (the
//       defining change below). V0.10 then refined the dialogs/output.
//
// Changes vs V0.8:
...
var CELL_LINE = newArray("Huh7", "VeroE6", "other cell line");	// Pre-selection for cell lines gets overwritten by dialog
