// ==========================================================
// Background Subtraction + Coloc Prep Pipeline  --  V0.14.2
...
//
// Changes vs V0.14:
//	CHANGED:	ROI area has to be over 120000 px^2
//	CHANGED:	Order token are choosen
//	CHENGED:	Area (<= min Area is also printed in log window
//
...
var SIGNAL_BG_MULT = 2;       // "real signal >= 68% higher than the Mock background"
